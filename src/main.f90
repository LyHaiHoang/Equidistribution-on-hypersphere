...
INTEGER                                 :: nstep_max       ! Maximum number of step for the minimization
INTEGER                                 :: format_out      ! Format for the output (used only for writing)
...
WRITE(10,*)  
WRITE(10,*) 0, dmin
WRITE(10,*) (nv+nv_fix)*(nb_mat+1), dmin
WRITE(10,*)  
WRITE(10,*) 0, dmax
WRITE(10,*) (nv+nv_fix)*(nb_mat+1), dmax
WRITE(10,*)  
...
! ... Write energies 
OPEN(10, FILE="energies.dat", STATUS="unknown", POSITION="rewind")
DO i=1,nstep_max
   WRITE(10,*) Etot(i) 
ENDDO
CLOSE(10)
