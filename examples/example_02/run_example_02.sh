...
opt=3  #chose optimization 0= nothing, 1=forces, 2= dot_prod, 3= both
nstepmax=100 #max number of steps
...
echo "$nstepmax"     >>input_variables.dat  # Method for initialization
