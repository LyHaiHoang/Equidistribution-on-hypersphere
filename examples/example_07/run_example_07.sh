...
for init in 1 2 3; do
  ...
  echo "10000"     >>input_variables.dat  # number of vectors
  echo "$init"    >>input_variables.dat  # chose initialization 1= Golden spiral, 2=pure random, 3= Box-Muller
  echo "1"        >>input_variables.dat  # chose optimization 0= nothing, 1=forces, 2= dot_prod, 3= both
  echo "1000"     >>input_variables.dat  # Max number of minimization steps
